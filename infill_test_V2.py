    ...
    for i, (airfoil1, airfoil2) in enumerate(zip(airfoils[:-1], airfoils[1:])):
        ...
        if num_layers > 0:
            for j in range(num_layers):
                ...
                steps = triangle_wave_infill(steps, layer[0].z)
...
def triangle_wave_infill(steps, z):
    # Extract the x values
    x_values = [point.x for point in steps]
...
num_points = 256 # The resolution / accuracy of your airfoil. 
...
chord_lengths = [100, 100]  # Chord lengths of the airfoils
